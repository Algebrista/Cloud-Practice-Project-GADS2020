# Lab topic: Creating GKE (Google Kubernetes Engine) via GCP Console.---From the topic Architecting with Google Kubernetes Engine-Foundation(Phase 1 learning Deep dive)
...
* To set a default project ID , run the following command
    ...
    --gcloud config set project qwiklabs-gcp-03-bc1f5ea0bba3
...
## Task 5: View details about workloads using command line
